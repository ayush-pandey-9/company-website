...
const Services: React.FC = () => {
  ...
  const handleServiceClick = (id: number) => {
    setActiveService(id);
    setActiveSubCard(servicesData[id - 1]?.services?.[0]?.title);
  ...
  return (
    <div
      className={`${styles.servicesContainer} container mx-auto py-8 px-5 text-white`}
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        {servicesData.map((service, index) => (
          <ServiceCard
            ...
            containerCustomClassName={
              "border-black bg-primary text-white hover:bg-secondary"
            }
